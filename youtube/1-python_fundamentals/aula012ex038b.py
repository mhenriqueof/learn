...
# Condições
if num1 == num2:
    print(f'O número {w}{num1}{cc} e {w}{num2}{cc} são \033[1;33miguais{cc}, não existindo um número maior entre eles.',end='')
elif num1 > num2:
    print(f'O {r}maior{cc} número é o {w}PRIMEIRO{cc}.',end=' ')
elif num2 > num1:
    print(f'O {r}maior{cc} número é o {w}SEGUNDO{cc}.',end='')
# Agradecimento
